...
import "./Home.css";
import profilePic from "../../../assets/kshitij.png";
...
function Home() {
  ...
  const developerInfo = {
    ...
    bio: "Leveraging data and AI to create impactful software solutions that tackle real-world challenges with innovation and precision.",
  };
  ...
  const developerInfo = {
    name: 'Kshitij Gupta',
    role: 'Passionate Software Engineer',
    bio: 'Passionate about building high-quality software
